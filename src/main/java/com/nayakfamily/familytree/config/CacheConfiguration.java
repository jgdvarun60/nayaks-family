...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nayakfamily.familytree.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nayakfamily.familytree.repository.UserRepository.USERS_BY_EMAIL_CACHE);
