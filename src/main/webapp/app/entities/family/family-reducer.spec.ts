...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './family.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FAMILY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FAMILY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FAMILY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FAMILY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FAMILY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FAMILY actions', async () => {
      const arg = 42666;
